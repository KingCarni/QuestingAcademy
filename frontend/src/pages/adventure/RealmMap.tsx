    ...
    <AdventureLayout title="Realm Map" subtitle="Import a scene map, inspect markers, and enter a realm" back="/adventure">
      <section className="w-full max-w-[90rem] mx-auto px-4 md:px-8 py-6 space-y-5 pb-28">
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px] xl:items-start">
          ...
          <aside className="rounded-[2.5rem] border-[5px] border-white bg-white/82 backdrop-blur-md shadow-2xl shadow-indigo-900/10 p-5 xl:sticky xl:top-6 max-h-[760px] overflow-y-auto" data-testid="realm-legend">
