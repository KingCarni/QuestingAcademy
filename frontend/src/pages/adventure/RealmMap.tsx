...
const RealmMap: React.FC = () => {
  ...
  return (
    <AdventureLayout title="Realm Map" subtitle="Import a scene map, inspect markers, and enter a realm" back="/adventure">
      <section className="w-full max-w-[112rem] mx-auto px-4 md:px-8 py-6 pb-28">
        ...
        <div className="flex w-full items-start justify-center gap-6">
          ...
          <aside className="w-[23rem] shrink-0 rounded-[2.5rem] border-[5px] border-white bg-white/82 backdrop-blur-md shadow-2xl shadow-indigo-900/10 p-5 sticky top-6 max-h-[38.5rem] overflow-y-auto" data-testid="realm-legend">
